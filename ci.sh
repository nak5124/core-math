...
FUNCTIONS_SPECIAL=(acos acosh acospi asin asinh asinpi asinpif atan atanf atan2 atan2f atan2pi atan2pif atanh atanpi atanpif cbrt cbrtl compoundf cos cosh cospi cospif erf erfc erfcf exp expf expl expq exp10 exp10q exp10m1 exp2 exp2l exp2q exp2m1 exp2m1f expm1 expm1q hypot hypotf hypotl hypotq lgamma lgammaf log log10 log10p1 log1p log2 log2l log2p1 pow powf powl rsqrt rsqrtl rsqrtq sin sincos sinh sinpi tan tanh tanpi tanpif tgamma)
