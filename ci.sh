...
<<<<<<< HEAD
FUNCTIONS_WORST=(acos asin atan atan2f atan2pif cbrt exp exp2 hypotf log log10 log1p log2 rsqrt sinh tanh)
=======
FUNCTIONS_WORST=(acos asin atan atan2f atan2pif cbrt cospi exp exp2 hypotf log log10 log1p log2 rsqrt sinh sinpi)
>>>>>>> master
