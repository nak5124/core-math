...
FUNCTIONS_WORST=(acos acosh asin asinh atan atan2f atan2pif cbrt cosh cospi erf erfc exp exp2 hypotf log log10 log1p log2 rsqrt sinh sinpi tan tanh tanpi atanh)
