...
FUNCTIONS_SPECIAL=(acos acosh acospi asin asinh asinpi atan atan2 atan2f atan2pi atan2pif atanh atanpi cbrt cos cosh cospi erf erfc erfcf exp exp10 exp10m1 exp10m1f exp2 exp2m1 exp2m1f expm1 hypot hypotf lgammaf log log10 log10p1 log1p log2 log2p1 pow powf powl rsqrt sin sinh sinpi tan tanh tanpi)
