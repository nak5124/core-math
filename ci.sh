...
FUNCTIONS_EXHAUSTIVE=(acosf acoshf asinf asinhf asinpif atanf atanhf cbrtf cosf coshf cospif erff erfcf expf exp10f exp2f expm1f logf log10f log1pf log2f rsqrtf sinf sinhf sinpif tanf tanhf tanpif)
