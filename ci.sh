...
FUNCTIONS_WORST=(acos acosh asin asinh atan atan2f atan2pif atanh cbrt cos cosh cospi erf erfc exp exp10 exp2 exp2m1 hypot hypotf log log10 log10p1 log1p log2 pow powf rsqrt sin sinh sinpi tan tanh tanpi)
