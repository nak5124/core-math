...
FUNCTIONS_WORST=(acos acosh asin asinh atan atan2f atan2pif cbrt cos cosh cospi erf erfc exp exp2 exp2m1 hypotf log log10 log1p log2 powf rsqrt sin sinh sinpi tan tanh tanpi atanh)
