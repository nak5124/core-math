...
FUNCTIONS_WORST=(acos acosh asin asinh atan atan2f atan2pif cbrt cos cosh cospi erf erfc exp exp2 hypotf log log10 log1p log2 rsqrt sin sinh sinpi tanh tanpi atanh)
