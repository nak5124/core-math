...
# statall("/tmp/log")
# ([((9223372036854775808, -64), (16725468296128548104, 10)),
#  ((16791671210650894396, 10), (14768712279871757614, 11)),
#  ((14825297384392339061, 11), (13225967449074772888, 12)),
#  ((13269473920946729378, 12), (12200005739657908140, 13)),
#  ((12220967948832578086, 13), (10762560651661059968, 14)),
#  ((10776812398094451488, 14), (12786308645202655660, 14))],
# [((-18446744073709551615, 3), (-11477974090308165387, 3)),
#  ((-11273010267266948145, 3), (-10658118798143296419, 3)),
#  ((-18446744073709551615, 2), (-9223372036854775807, -64))])
def statall(f):
   f = open(f,"r")
   l = []
   while true:
